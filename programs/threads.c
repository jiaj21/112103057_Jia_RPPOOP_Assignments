...
*
*******************************************************************************/
//do time ./objfile to see time, compare by calling computation function twice, then using threads, then using joing of thread1 directly after create and then create and join for thread2.inthe last case it takes more time as join waits for thread1 to finish and only then craetes thread2
#include <stdio.h>
#include <pthread.h>
